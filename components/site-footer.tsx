...
import { Instagram, Youtube, Twitter, Facebook, CloudIcon as SoundCloud } from "lucide-react"
    ...
    <footer className="bg-[#1A1A1A] text-white py-12">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Explore Section */}
          <div>
            <h3 className="text-sm font-semibold mb-4 text-gray-400">Explore</h3>
            <div className="space-y-2">
              <Link href="/shows" className="block text-sm hover:text-gray-300">
                Shows
              </Link>
              <Link href="/schedule" className="block text-sm hover:text-gray-300">
                Schedule
              </Link>
            </div>

            <div className="mt-8">
              <h3 className="text-sm font-semibold mb-4 text-gray-400">Download the app</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold mb-4 text-gray-400">Channels</h3>
                    ...
                    {Object.entries(channel.socials).map(([platform, url]) => (
                      <Link key={platform} href={url}>
                        <Button size="icon" variant="ghost" className="h-8 w-8 rounded-full">
                          ...
                          {platform === "soundcloud" && <SoundCloud className="h-4 w-4" />}
                        </Button>
                      </Link>
                    ))}
                  </div>
